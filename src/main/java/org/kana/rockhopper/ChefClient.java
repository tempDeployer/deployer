...
public class ChefClient {
	...
	private static ChefApiClient cac = new ChefApiClient(ConfigurationUtil.getKey("deployer.chef.user"), ConfigurationUtil.getKey("deployer.chef.pemfile"), ConfigurationUtil.getKey("deployer.chef.serverurl"));
