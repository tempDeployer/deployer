...
public class VmxService implements Runnable{
	...
	public VmxService(String timeStamp, String ip, boolean deployEc2)
	{
		...
		this.logFilePath = ConfigurationUtil.getKey("deployer.logs.dir") + "/"	+ timeStamp + ".log";
	...
	public void run() {
		...
		try {
			...
			bw.newLine();
			bw.write("Please download the new vmx from : http//" +InetAddress.getLocalHost().getHostAddress() +"/vmx/"+cloneName+".tgz");
